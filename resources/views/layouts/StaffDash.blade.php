...
<head>
    ...
    <title>Staff Record Management System</title>
        ...
        <div class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="/staff/home"><i class="glyphicon glyphicon-file"></i> Upload Files</a>
                    </li>

                    <li>
                        <a href="/staff/record"><i class="glyphicon glyphicon-list"></i> View Record</a>
                    </li>
